	...
	var CountdownComponent = (function () {
	    function CountdownComponent() {
	        ...
	        setInterval(function () {
	            var now = moment();
	            _this.clock = endTime.diff(now, 'seconds');
	            _this.percent = Math.floor(_this.clock / endTime.diff(startTime, 'seconds') * 100);
	            _this.days = Math.floor(endTime.diff(now, 'days'));
	            _this.hours = Math.floor(endTime.diff(now, 'hours') - _this.days * 24);
	            _this.minutes = Math.floor(endTime.diff(now, 'minutes') - _this.days * 24 * 60 - _this.hours * 60);
	            _this.seconds = Math.floor(endTime.diff(now, 'seconds') - _this.days * 24 * 3600 - _this.hours * 3600 - _this.minutes * 60);
	        }, 500);
	    }
